...
<html>
 <head>
  <title>Intégration de Jquery Fullcalandar avec PHP et Mysql (Administration)</title>
   ...
   var calendar = $('#calendar').fullCalendar({
    ...
    select: function(start, end, allDay)
    {
      var dialog=$("#dialog").dialog({ modal: true,width:600, buttons: {
        'Valider' : function() {
            $("#outside").dialog({buttons : { 'Valider' : function() { $("#outside").dialog('close'); } }});
 ...
 <body>
  <br />
  <h2 align="center"><a href="#"><b>Intégration de Jquery Fullcalandar avec PHP et Mysql (Administration)</b></a></h2>
  <br />
  <div class="container">
  <h1 id="choose" style="display: none;">Veuillez Sélectionner une salle disponible</h1>
   <div id="calendar"></div>
  </div>
